...
api_bbox = "bbox=-118.2829927423854,34.500880266090036,-118.2829927423854,34.500880266090036,&"
api_requests = []
...
for api_request in api_requests:
    ...
    for map in response_maps:
        if map['title'] not in maps:
            print(map)
            maps[map['title']] = {'sourceId': map['sourceId'], 'boundingBox': map['boundingBox'], 'downloadURL': map['downloadURL'], 'publicationYear': map['publicationDate'][0:4]}
